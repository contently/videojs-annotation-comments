...
class MockedAnnotationState extends AnnotationState {
    ...
    set activeAnnotation (annotation) { this._activeAnnotation = annotation }
    get activeAnnotation () { return this._activeAnnotation || { close: () => { return 'closing annotation!' } } }
    activeAnnotationsForTime (time) { return timeMap[time] }
    openAnnotation () { this._annotationWasOpened = true }
}
