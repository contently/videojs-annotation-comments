...
exports['comment'] = Handlebars.template({
  ...
  main: function(container, depth0, helpers, partials, data) {
    ...
    return (
      ...
      alias4(
        ((helper =
          (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),
      ...
      alias4(
        container.lambda(
          (stack1 = depth0 != null ? depth0.meta : depth0) != null ? stack1.user_name : stack1,
          depth0
        )
      ) +
      ...
      alias4(
        ((helper =
          (helper = helpers.timeSince || (depth0 != null ? depth0.timeSince : depth0)) != null
            ? helper
            : alias2),
        typeof helper === alias3
          ? helper.call(alias1, { name: 'timeSince', hash: {}, data: data })
          : helper)
      ) +
      '\n      <span class="vac-delete-comment">&nbsp;&nbsp;X</span>\n    </div>\n  </div>\n  <div class="vac-comment-body">\n    ' +
      alias4(
        (helpers.breaklines || (depth0 && depth0.breaklines) || alias2).call(
          alias1,
          depth0 != null ? depth0.body : depth0,
          { name: 'breaklines', hash: {}, data: data }
        )
      ) +
      '\n  </div>\n</div>\n'
    );
  ...
  main: function(container, depth0, helpers, partials, data, blockParams) {
    ...
    return (
      ...
      container.escapeExpression(
        ((helper =
          (helper = helpers.rangeStr || (depth0 != null ? depth0.rangeStr : depth0)) != null
            ? helper
...
exports['controls'] = Handlebars.template({
  '1': function(container, depth0, helpers, partials, data) {
    ...
    return (stack1 = helpers['if'].call(
      ...
      depth0 != null ? depth0.showControls : depth0,
      {
        name: 'if',
        hash: {},
  ...
  '2': function(container, depth0, helpers, partials, data) {
    ...
    return (
      ...
      ((stack1 = helpers['if'].call(
        depth0 != null ? depth0 : container.nullContext || {},
        depth0 != null ? depth0.showNav : depth0,
        {
          name: 'if',
          hash: {},
  ...
  '6': function(container, depth0, helpers, partials, data) {
    ...
    return (
      ...
      ((stack1 = helpers['if'].call(
        depth0 != null ? depth0 : container.nullContext || {},
        depth0 != null ? depth0.internalCommenting : depth0,
        {
          name: 'if',
          hash: {},
  ...
  main: function(container, depth0, helpers, partials, data) {
    ...
    return (
      ((stack1 = helpers.unless.call(alias1, depth0 != null ? depth0.adding : depth0, {
        name: 'unless',
        hash: {},
...
exports['draggable_marker'] = Handlebars.template({
  ...
  main: function(container, depth0, helpers, partials, data) {
    ...
    return (
      ...
      alias4(
        ((helper =
          (helper = helpers.left || (depth0 != null ? depth0.left : depth0)) != null
            ? helper
            : alias2),
        typeof helper === alias3
          ? helper.call(alias1, { name: 'left', hash: {}, data: data })
          : helper)
      ) +
      '; width:' +
      alias4(
        ((helper =
          (helper = helpers.width || (depth0 != null ? depth0.width : depth0)) != null
            ? helper
            : alias2),
        typeof helper === alias3
          ? helper.call(alias1, { name: 'width', hash: {}, data: data })
          : helper)
      ) +
      ';">\n</div>\n'
    );
...
exports['marker'] = Handlebars.template({
  ...
  '5': function(container, depth0, helpers, partials, data) {
    ...
    return (stack1 = helpers['if'].call(
      depth0 != null ? depth0 : container.nullContext || {},
      depth0 != null ? depth0.tooltipBody : depth0,
      {
        name: 'if',
        hash: {},
        fn: container.program(6, data, 0),
  ...
  '6': function(container, depth0, helpers, partials, data) {
    ...
    return (
      ...
      ((stack1 = helpers['if'].call(alias1, depth0 != null ? depth0.tooltipRight : depth0, {
        name: 'if',
        hash: {},
        fn: container.program(7, data, 0),
        inverse: container.noop,
      ...
      alias4(
        ((helper =
          (helper = helpers.tooltipTime || (depth0 != null ? depth0.tooltipTime : depth0)) != null
            ? helper
            : alias2),
        typeof helper === alias3
          ? helper.call(alias1, { name: 'tooltipTime', hash: {}, data: data })
          : helper)
      ) +
      '</b> - ' +
      alias4(
        ((helper =
          (helper = helpers.tooltipBody || (depth0 != null ? depth0.tooltipBody : depth0)) != null
            ? helper
            : alias2),
        typeof helper === alias3
          ? helper.call(alias1, { name: 'tooltipBody', hash: {}, data: data })
          : helper)
      ) +
      '\n        </span>\n    </div>\n'
    );
  ...
  main: function(container, depth0, helpers, partials, data) {
    ...
    return (
      ...
      '" class="vac-marker ' +
      ((stack1 = helpers['if'].call(alias1, depth0 != null ? depth0.rangeShow : depth0, {
        name: 'if',
        hash: {},
        fn: container.program(1, data, 0),
        inverse: container.noop,
      ...
      alias4(
        ((helper =
          (helper = helpers.zIndex || (depth0 != null ? depth0.zIndex : depth0)) != null
            ? helper
            : alias2),
        typeof helper === alias3
          ? helper.call(alias1, { name: 'zIndex', hash: {}, data: data })
          : helper)
      ) +
      '">\n' +
...
exports['new_comment'] = Handlebars.template({
  ...
  main: function(container, depth0, helpers, partials, data) {
    ...
    return (
      ...
      alias4(
        ((helper =
          (helper = helpers.top || (depth0 != null ? depth0.top : depth0)) != null
            ? helper
            : alias2),
        typeof helper === alias3
          ? helper.call(alias1, { name: 'top', hash: {}, data: data })
          : helper)
      ) +
      'px;right:' +
      alias4(
        ((helper =
          (helper = helpers.right || (depth0 != null ? depth0.right : depth0)) != null
            ? helper
            : alias2),
        typeof helper === alias3
          ? helper.call(alias1, { name: 'right', hash: {}, data: data })
          : helper)
      ) +
      'px">\n      <textarea placeholder="Enter comment..."></textarea>\n      <div>\n        <button class="vac-button">SAVE</button>\n        <a>Cancel</a>\n      </div>\n    </div>\n  </div>\n'
    );
